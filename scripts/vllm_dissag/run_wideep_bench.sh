...
[[ "$BENCH" == "mrcr" ]] && echo "MRCR needles=${MRCR_NEEDLES:-2}  bins=${MRCR_BINS:-}  per_bin=${MRCR_PER_BIN:-}  MAXTOK=${MRCR_MAXTOK:-}  TIMEOUT=${MRCR_TIMEOUT:-}  MAX_CTX=${MRCR_MAX_CTX:-}  THINKING=chat  PRIME=OFF  DATA_DIR=${MRCR_DATA_DIR:-/shared_inference/bbarakat/datasets/openai_mrcr}"
